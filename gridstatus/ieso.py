...
class IESO(ISOBase):
    ...
    def _process_transmission_limits(self, xml_content: str) -> pd.DataFrame:
        ...
        facility_types = {"Internal": "Internal", "Intertie": "Intertie"}

        for xml_type, output_type in facility_types.items():
            xpath = (
                f"//ns:TransmissionFacilityData[ns:TransmissionFacility='{xml_type}']"
            )
