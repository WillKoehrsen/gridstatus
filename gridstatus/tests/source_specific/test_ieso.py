...
class TestIESO(BaseTestISO):
    ...
    """get_lmp_real_time_5_min_operating_reserves"""
    ...
    def test_get_lmp_real_time_5_min_operating_reserves_latest(self):
        with file_vcr.use_cassette(
            "test_lmp_get_real_time_5_min_operating_reserves_latest.yaml",
        ):
            data = self.iso.get_lmp_real_time_5_min_operating_reserves("latest")
    ...
    def test_get_lmp_real_time_5_min_operating_reserves_historical_date_range(self):
        # Only date for which data is available
        start_date = pd.Timestamp.utcnow() - pd.DateOffset(days=3)
        ...
        with file_vcr.use_cassette(
            ...
            data = self.iso.get_lmp_real_time_5_min_operating_reserves(
                start_date,
                end=end_date,
            )
